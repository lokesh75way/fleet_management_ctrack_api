...
import { getFleetStatus, getFleetUsage, getFleetFuel, getOverspeed, getMaintainanceReminder, getRenewalReminder, fleetIdle, getTasks, getTechnicianTaskCount } from "../controllers/Dashboard";
...
router.get("/task-count", asyncHandler(getTechnicianTaskCount));
